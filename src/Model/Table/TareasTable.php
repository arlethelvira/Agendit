...
class TareasTable extends Table
{
    ...
    // Auto-completa fecha_creacion y estado al insertar, si no vienen ya definidos
    public function beforeSave(EventInterface $event, \Cake\Datasource\EntityInterface $entity, ArrayObject $options): void
    {
        if ($entity->isNew()) {
    ...
    // Solo tareas activas de un usuario, con categoría y subtareas

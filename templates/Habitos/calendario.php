<?php
/**
 * Vista de contenido únicamente — el layout (templates/layout/default.php)
 * ya pone <html>, <head>, <body>, el wrapper y el menú.
 */
$this->assign('title', 'Schedule - Agendit');
?>
...
<!-- JS específico de esta página (FullCalendar) -->

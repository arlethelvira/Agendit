    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            ...
            <div class="container-xxl">
                <?= $this->element('page-title', array('title' => 'Products List', 'subTitle' => 'Ecommerce')) ?>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mt-0 mb-1">
                                                                <a href="apps-ecommerce-product-detail" class="text-reset">G15
                                                                    Gaming
                                                                    Laptop</a>
                                                            </h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mt-0 mb-1">
                                                                <a href="apps-ecommerce-product-detail" class="text-reset">Sony
                                                                    Alpha
                                                                    ILCE
                                                                    6000Y
                                                                    24.3 MP
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mt-0 mb-1">
                                                                <a href="apps-ecommerce-product-detail" class="text-reset">Apple
                                                                    iPad Pro
                                                                    with
                                                                    Apple M1
                                                                    chip.</a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h5 class="mt-0 mb-1">
                                                                <a href="apps-ecommerce-product-detail" class="text-reset">Adam
                                                                    ROMA
                                                                    USB-C /
                                                                    USB-A
                                                                    3.1

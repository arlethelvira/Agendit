...
<head>
    <?= $this->element('title-meta', array('title' => 'Sign In 2')) ?>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5">
                        ...
                        <div class="card-body px-3 py-5">
                            ...
                            <div class="px-4">
                                <form action="/" class="authentication-form">
                                    ...
                                    <div class="mb-3">
                                        <a href="auth-password2" class="float-end text-muted text-unline-dashed ms-1">Reset password</a>
                    ...
                    <p class="text-white mb-0 text-center">
                        New here?
                        <a href="auth-signup2" class="text-white fw-bold ms-1">Sign Up</a>
                    </p>
                </div>
                <!-- end col -->
            </div>

...
<head>
    <?= $this->element('title-meta', array('title' => 'Orders List')) ?>
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            ...
            <div class="container-xxl">
                <?= $this->element('page-title', array('title' => 'Orders List', 'subTitle' => 'Ecommerce')) ?>
                            ...
                            <div class="table-responsive table-centered">
                                <table class="table text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="apps-ecommerce-order-detail">#RB0025</a>
                                            </td>
                                            <td>06/09/2018</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="apps-ecommerce-order-detail">#RB9064</a>
                                            </td>
                                            <td>12/07/2019</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="apps-ecommerce-order-detail">#RB1002</a>
                                            </td>
                                            <td>13/07/2018</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="apps-ecommerce-order-detail">#RB9622</a>
                                            </td>
                                            <td>18/11/2019</td>
                                            <td>
                                                <img src="/images/products/product-3.png" alt="product-3" class="img-fluid avatar-sm" />
                                        ...
                                        <tr>
                                            <td>
                                                <a href="apps-ecommerce-order-detail">#RB8745</a>
                                            </td>
                                            <td>07/03/2019</td>
                                            <td>
                                                <img src="/images/products/product-4.png" alt="product-4" class="img-fluid avatar-sm" />

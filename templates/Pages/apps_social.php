...
<head>
    <?= $this->element('title-meta', array('title' => 'Social')) ?>
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            ...
            <div class="container-xxl">
                <?= $this->element('page-title', array('title' => 'Social', 'subTitle' => 'Apps')) ?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex gap-2 align-items-center mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="m-0">
                                                    <a href="pages-profile" class="text-reset">Thelma Fridley</a>
                                                </h5>
                                                <p class="text-muted mb-0">
                                                    <small>about 1 hour
                                                        ago</small>
                                            ...
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="w-100">
                                                    <div class="w-100 bg-light p-2 rounded">
                                                        <h5 class="mt-0">
                                                            <a href="pages-profile" class="text-reset">Jeremy
                                                                Tomlinson</a>
                                                    ...
                                                    <div class="d-flex align-items-start mt-3">
                                                        ...
                                                        <div class="w-100 bg-light p-2 rounded">
                                                            <h5 class="mt-0">
                                                                <a href="pages-profile" class="text-reset">Kathleen
                                                                    Thomas</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex gap-2 align-items-center mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="m-0">
                                                    <a href="pages-profile" class="text-reset">Jonathan Tiner</a>
                                                </h5>
                                                <p class="text-muted mb-0">
                                                    <small>about 11 hour
                                                        ago</small>

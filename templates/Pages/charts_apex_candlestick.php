    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            ...
            <div class="container-xxl">
                ...
                <?= $this->element('page-title', array('title' => 'Candlestick Charts', 'subTitle' => 'Charts')) ?>
                    ...
                    <div class="col-xl-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="mb-0"><span class="fw-medium">Find the JS file for the following chart at:</span> <code> ../src/js/components/apexchart-candlestick.js</code></p>
                            </div><!-- end card-body -->
                        </div><!-- end card -->

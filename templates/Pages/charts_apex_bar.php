        ...
        <div class="wrapper">
            ...
            <div class="page-content">
                ...
                <div class="container-xxl">
                    <?= $this->element('page-title', array('title' => 'Bar Charts', 'subTitle' => 'Charts')) ?>
                    ...
                    <div class="row">
                        <div class="col-xl-9">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        >
                                        <code>
                                            ../src//js/components/apexchart-bar.js</code
                                        >
                                    </p>
                                </div>
                                <!-- end card-body -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5
                                        class="card-title anchor"
                                        id="full-stacked"
                                    >
                                        100% Stacked Bar Chart<a
                                            class="anchor-link"
                                            href="#full-stacked"
                                            >#</a
                                        >
                        ...
                        <div class="col-xl-3">
                            <div class="card docs-nav">
                                <ul class="nav bg-transparent flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="#grouped" class="nav-link"
                                            >Grouped Bar Chart</a
                                        >
                                    </li>
                                    <li class="nav-item">
                                        <a href="#stacked" class="nav-link"
                                            >Stacked Bar Chart</a
                                        >
                                    </li>
                                    <li class="nav-item">
                                        <a href="#full-stacked" class="nav-link"
                                            >100% Stacked Bar Chart</a
                                        >
                                    </li>
                                    <li class="nav-item">
                                        <a href="#negative" class="nav-link"
                                            >Bar with Negative Values</a
                                        >
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="#image-fill" class="nav-link"
                                            >Bar with Image Fill</a
                                        >
                                    </li>
                                    <li class="nav-item">
                                        <a href="#datalables" class="nav-link"
                                            >Custom DataLabels Bar</a
                                        >
                                    </li>
                                    <li class="nav-item">
                                        <a href="#pattern" class="nav-link"
                                            >Patterned Bar Chart</a
                                        >
                                    </li>
                                    <li class="nav-item">

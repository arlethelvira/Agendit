...
<head>
    <?= $this->element('title-meta', array('title' => 'Apex Area Chart')) ?>
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            ...
            <div class="container-xxl">
                <?= $this->element('page-title', array('title' => 'Area Charts', 'subTitle' => 'Charts')) ?>
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-0">
                                    <span class="fw-medium">Find the JS file for the following
                                        chart at:</span>
                                    <code>
                                        ../src/js/components/apexchart-area.js</code>
                                </p>
                            </div>
                            <!-- end card-body -->
                        </div>
